 ...
 * */
public class DumpYardWeightSuperActivity extends AppCompatActivity {
    ...
    private void initToolbar() {
        toolbar.setTitle(R.string.title_activity_super_dump_yard_weight);
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
    }

    private void generateId() {
        setContentView(R.layout.activity_super_dump_yard_weight);
        mContext = DumpYardWeightSuperActivity.this;
